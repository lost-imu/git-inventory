...
namespace InventorySystem1._0
{
    class MyCon
    {
        ...
        // lost_inventory
        private static readonly string ConString = "server=160.153.131.197;user id=eeb;database=lost_inventory_farm;port=3306;password=BPxK6cnVibm~?;sslMode=none;allowuservariables=True;Convert Zero Datetime=True;Character Set=utf8;";
